...
SETTING_SPECS: tuple[SettingSpec, ...] = (
    ...
    SettingSpec(
        ...
        "true",
        "TAVILY_ENABLED",
        "Runs Tavily web discovery when its API key is configured.",
    ),
    SettingSpec(
        "hunter_api_key",
        "Hunter API key",
    ...
    SettingSpec(
        ...
        "true",
        "HUNTER_ENABLED",
        "Runs Hunter enrichment when its API key is configured.",
    ),
    SettingSpec(
        "abstract_api_key",
        "Abstract API key",
    ...
    SettingSpec(
        ...
        "true",
        "ABSTRACT_ENABLED",
        "Runs Abstract email verification when its API key is configured.",
    ),
    SettingSpec(
        "gnews_api_key",
        "GNews API key",
    ...
    SettingSpec(
        ...
        "true",
        "WAPPALYZER_ENABLED",
        "Runs Wappalyzer enrichment when its API key is configured.",
    ),
    SettingSpec(
        "crunchbase_api_key",
        "Crunchbase API key",
    ...
    SettingSpec(
        ...
        "true",
        "CRUNCHBASE_ENABLED",
        "Runs Crunchbase enrichment when its API key is configured.",
    ),
    SettingSpec(
        "whoisxml_api_key",
        "WhoisXML API key",
    ...
    SettingSpec(
        ...
        "true",
        "WHOISXML_ENABLED",
        "Runs WhoisXML enrichment when its API key is configured.",
    ),
    SettingSpec(
    ...
    SettingSpec(
        "securitytrails_enabled",
        "Use SecurityTrails",
        "Lead data",
        "boolean",
        "true",
        "SECURITYTRAILS_ENABLED",
        "Runs SecurityTrails enrichment when its API key is configured.",
    ),
    SettingSpec(
        ...
        "",
        "LEAD_FINDER_SOURCE_URLS",
        "Comma- or newline-separated public company or directory URLs used for scrape-first discovery.",
    ),
    SettingSpec(
        "redis_url",
        "Redis queue URL",
    ...
    SettingSpec(
        ...
        "AutoReach",
        "SENDER_FROM_NAME",
        "Display name used by the configured email delivery provider.",
    ),
    SettingSpec(
        "sender_first_name",
        "Sender first name",
        ...
        "",
        "SENDER_FIRST_NAME",
        "Required when generating live email drafts.",
    ),
    SettingSpec(
        "sender_last_name",
        "Sender last name",
    ...
    SettingSpec(
        ...
        "",
        "SENDER_SIGNATURE",
        "Optional signature block. A name, title, and company signature is generated when blank.",
    ),
    SettingSpec(
        "sender_linkedin_url",
        "Sender LinkedIn URL",
